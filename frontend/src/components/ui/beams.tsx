...
export const BackgroundBeams = React.memo(({ className, style }: BackgroundBeamsProps) => {
  return (
    <div className={cn("pointer-events-none absolute inset-0 h-full w-full", className)} style={style}>
      <svg
